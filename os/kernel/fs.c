...
static const uint8_t file_lardos_lars[] =
    ...
    "li Use media list, media format Z, media write Z note.txt hello, dir Z:, type Z:note.txt, and copy R:notes.txt Z:notes.txt for auxiliary, USB-style, and floppy-style media stores.\n"
    ...
    "li Use dir X: for read-only system files and dir R: for every writable RAM file; the two listings are no longer mixed together.\n"
...
static const uint8_t file_dosmode_guide[] =
    ...
    "ITEM dos map -> show C:/A:/Z:/U:/R: drive mappings.\n"
...
static const uint8_t file_media_guide[] =
    ...
    "ITEM In L-DOS mode, A: maps to native Y:, Z: maps to native Z:, U: maps to native A:, and S: remains a Z: compatibility alias.\n"
    "SECTION Honesty\n"

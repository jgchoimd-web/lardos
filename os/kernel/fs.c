...
static const uint8_t file_distro_guide[] =
    "LARDD 1\n"
    "TITLE lardos-arm-mobile Distribution\n"
    "TEXT lardos-arm-mobile is the ARM phone/tablet source-port branch for LardOS.\n"
    ...
    "SECTION Target\n"
    "ITEM Architecture: ARM/AArch64 mobile devices.\n"
    "ITEM Devices: phones, tablets, dev boards with mobile display/input constraints.\n"
    "ITEM Channel: beta source/port branch.\n"
    "SECTION Required Port Work\n"
    "ITEM ARM exception/vector entry, MMU tables, timer, interrupt controller, framebuffer/display, storage, and touch/input paths.\n"
    "ITEM Mobile power policy must be visible and user-editable rather than hidden firmware magic.\n"
    ...
    "ITEM Do not remove desktop/CLI/RXE/KMO ideas just because the target is mobile; adapt them visibly.\n"
    "END\n";

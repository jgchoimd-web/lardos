...
static const uint8_t file_lardos_lars[] =
    ...
    "li Use lar pass secret.lar secret.txt notes.txt password to create a password-protected native .lar archive, then lar extract secret.lar secret.txt password.\n"
    ...
    "cmd lar extract secret.lar secret.txt open\n"

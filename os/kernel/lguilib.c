...
static void copy_default(lguilib_theme_t* out)
{
    ...
    out->name[i] = '\0';
    out->title_bg = 0xFF304060u;
    out->title_fg = 0xFFFFFFFFu;
    out->title_accent = 0xFFE7F0FFu;
    out->panel_bg = 0xFF202840u;
    out->border = 0xFF05070Cu;
    out->tab_active = 0xFF3E5F82u;
    out->tab_idle = 0xFF282838u;
    out->tab_hover = 0xFF343A50u;
    out->tab_accent = 0xFF72D6FFu;
    out->button_border = 0xFF203060u;
    out->button_hover = 0xFFD5E5FFu;
    out->button_inner = 0x6680A0FFu;
    out->output_frame = 0xFF5A6B86u;
    out->hint_fg = 0xFFAFC2D8u;
    out->shadow = 0x33000000u;
    out->widget_count = 0;
